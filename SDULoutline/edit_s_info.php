...
<title>SDUL学生信息维护</title>
</head>
<body>
<h1 style = "text-align:center">SDUL学生信息维护</h1>
<form action="edit_s_info.php" method="post" onsubmit="return empty()">
  <input type="hidden" value=<?php $s_id=$_GET["s_id"];echo "$s_id";?> name="s_id"/>
<?php
...
<a href="check_s_info.php"><input type="button" value="返 回"/></a></td></tr>
</table>
<?php
}
?>
...
<?php
  ...
  $sql_name2="UPDATE $sdul_leave
	...
	if($re and $re2 and $re3){
		echo"<meta http-equiv=\"refresh\" content=\"2;url=check_s_info.php\">";
		echo"信息维护成功！<p>";
		echo"2秒后返回";
